    ...
    <div className="w-screen bg-white z-20">
      ...
      >
        ...
        <div
          className="
            grid 
            grid-cols-[5%_7%_42%_10%_35%] 
            sm:grid-cols-[15%_10%_30%_10%_35%] 
        ...
        >
          ...
          <div className="border-r border-[#ADD8E6] flex items-center justify-center lg:h-10 lg:-mt-4 xl:h-15">
            <MailOutlinedIcon className="text-xs sm:text-sm lg:text-sm" />
          </div>

          {/* Gmail account */}
          <div className="border-r border-[#ADD8E6] flex items-center pl-4 text-xs justify-start sm:pl-2 lg:pl-4 lg:h-10 sm:text-xs lg:text-sm sm:font-bold lg:-mt-4 xl:h-15">
          ...
          <div className="flex border-r border-[#ADD8E6] items-center justify-center lg:h-10 lg:-mt-4 xl:h-15">
            <img
              src="/ng-flag.png"
              alt="nigeria flag"
              className="object-cover w-5 h-5 sm:w-7 sm:h-7 xl:-mt-2"

            />
          </div>

          {/* Phone number */}
          <div className="flex items-center justify-start pl-2 text-xs lg:text-sm sm:font-bold ">
        ...
        <div className="grid grid-cols-[43%_30%_20%] sm:grid-cols-[30%_20%_50%] lg:hidden flex-1">
          {/* English dropdown */}
          <div className="flex items-center justify-center border-r border-[#ADD8E6]">
            <ul className="flex list-none ml-22">
              <li className="relative cursor-pointer group py-2 text-xs">
                English <KeyboardArrowDownIcon className="text-xs sm:text-sm" />
                <ul className="absolute top-full left-0 bg-white shadow-lg border border-[#051753] hidden group-hover:block z-30 min-w-[7.5rem]">
                  <li className="mb-2 px-2 py-1">USA</li>
                  <li className="mb-2 px-2 py-1">UK</li>
                  <li className="mb-2 px-2 py-1">CA</li>
