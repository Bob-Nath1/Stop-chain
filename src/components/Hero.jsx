...
const Hero = () => {
  return (
    <section className="grid grid-cols-1 grid-rows-[1fr_2fr_1fr] text-center  overflow-visible mt-49 -ml-23 md:mt-165 lg:mt-70 xl:-ml-14">
      <h2 className="text-sm font-semibold uppercase -mt-14 -ml-7 md:-ml-50 md:-mt-22 lg:text-lg lg:-ml-88 lg:-mt-17 xl:-ml-130 xl:text-md xl:-mt-32">
  Africa’s Leading Digital Technology Solutions 
  <br className="hidden md:block lg:block xl:hidden" />
  <span className="inline md:block md:-ml-75 lg:block lg:-ml-96 xl:inline xl:ml-0">  Provider</span>
</h2>
<div className="absolute w-full h-119 ml-23 -mt-40 bg-[#f7f7f7] z-[-1] lg:-mt-58 lg:h-189 xl:ml-14 xl:h-150" >      </div>


      <p className="font-semibold text-5xl leading-4 mb-1 ml-32 flex flex-col items-start text-left text-black ml-26 -mt-12 lg:text-7xl lg:leading-7 xl:-mt-29">
  Design
  ...
  <span className="inline-block w-2 h-2 mt-1 bg-black rounded-full ml-38  lg:ml-58 lg:mt-2  lg:h-3 lg:w-3" />
      ...
      <p className="text-base ml-32 mt-3 text-black justify-self-start">
        Innovative Digital Solutions
      </p>

      <div className="justify-self-start z-[1] flex gap-2 mt-8 ml-32 ">
