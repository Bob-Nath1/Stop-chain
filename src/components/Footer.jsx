...
const Footer = () => {
  return (
    <footer className="bg-white text-black font-sans px-6 py-12 mt-170 lg:mt-110 xl:mt-10">
      <div className="max-w-6xl mx-auto grid grid-cols- gap-12">
        {/* Logo */}
        ...
        <div className="grid grid-cols-1 gap-8 ml-14 md:grid-cols-2 lg:grid-cols-3 lg:mt-17 lg:-ml-3">
          ...
          {/* Address */}
          <div className="flex items-start gap-4 -ml-81 md:col-span-2 justify-center md:ml-4  lg:col-span-1 lg:justify-start lg:-mt-12 xl:-ml-60">
            <img
        ...
        {/* Divider */}
        <div className="h-5 w-110 ml-18 bg-[#061f71] w-3/4 mx-auto md:w-160 lg:w-220 lg:ml-6 xl:w-270"></div>
        ...
        <div className="grid grid-cols-2 gap-8 ml-10 xl:grid-cols-3">
         ...
         <p className="mt-4 font-bold text-sm ml-40 mt-20 lg:text-base lg:ml-99">
                Chain Consult © 2024{" "}
