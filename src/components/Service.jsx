...
const Service = () => {
    ...
    <div className="min-w-375  mt-139 relative box-border md:mt-154 lg:mt-144 lg:-ml-34 xl:mt-200">
      ...
      <div className="flex flex-wrap items-center gap-5 relative ">
        <div className="relative w-full lg:w-1/2">
          <img
            src="Big image.png"
            className="absolute h-180 ml-20 -mt-119 lg:-ml-10 lg:-mt-188 lg:h-180 lg:w-128 lg:ml-19 md:h-225 md:w-170 md:ml-12 md:-mt-127 xl:h-270 xl:w-170 xl:ml-14"
            alt="Descriptive image alt text"
            loading="lazy"
          />
        </div>

        <div className="p-5 max-w-3xl ml-25 mt-75 md:mt-112 md:ml-16 lg:-ml-35  lg:-mt-101 lg:max-w-md xl:ml-20 xl:-mt-157 xl:max-w-lg ">
          ...
          <p className="text-base -ml-4 mb-0 leading-7 max-w-lg md:max-w-2xl xl:max-w-9xl">
            In today’s digital driven marketplace, your business can stand out by maximizing the potential of technology. At Chainconsults, we specialize in designing and building appealing and customer-focused products that help businesses across Africa excel in their various industries.
              ...
              <p className="relative -ml-4 max-w-lg text-base leading-7 text-black text-left h-19 before:content-[''] before:absolute  before:-left-8 before:w-0.5 before:h-full before:bg-[#051753] md:max-w-2xl xl:max-w-9xl">
          ...
          <div className="grid grid-cols-1 gap-8 mt-48 xl:grid-cols-2 xl:gap-1 xl:mt-44 xl:-ml-14">
  {/* Box 1 */}
  <div className="flex flex-col justify-between bg-white p-4 py-9 h-72 w-138 -ml-19 md:w-168 md:-ml-9 lg:h-70 xl:h-93 xl:w-63">
    <img
    ...
    <div className="px-4">
      ...
      <p className="text-base -mt-8 md:text-sm md:leading-6 lg:text-md lg:max-w-sm lg:leading-6">
  ...
  {/* Box 2 */}
  <div className="flex flex-col justify-between bg-white py-9 p-4 h-72 w-138 -ml-19 md:mb-11 lg:h-70  md:w-168 md:-ml-9 xl:h-93 xl:w-63">
    <img
      className="w-13 h-13 mb-2 ml-4 mt-4"
    ...
    <div className="px-4">
      ...
      <p className="text-base -mt-8 md:text-sm md:leading-6 lg:text-md lg:max-w-sm lg:leading-6">
        ...
        <div className="absolute  w-178 h-504 bg-[#f7f7f7] z-[-1] -ml-15 -mt-110 md:w-full md:h-579  lg:w-294 lg:ml-45 lg:h-330 xl:w-full" />
      </div>
      {/* Solution Section */}
      <div className="mt-80 md:mt-94 md:ml-9 lg:ml-64 xl:ml-114 xl:mt-146  ">
        <h1 className=" text-8xl font-semibold text-blue-900 opacity-4 -mt-44 ml-40 lg:text-9xl">
          Services
        </h1>
        <div className="flex flex-col items-center mr-204 -mt-17 lg:ml-99">
          <p className="uppercase font-semibold text-base mb-0 ">Services</p>
          <h2 className="text-4xl font-semibold mt-0">
      ...
      {/* Services Grid */}
      <div className="grid grid-cols-1 mt-20 gap-7 ml-16 lg:grid-cols-2 lg: lg:px-6 lg:ml-40 xl:ml-68">
        {/* Analytics */}
        <div className="flex flex-col items-center justify-center text-center border border-blue-100 bg-white max-w-lg   py-5 md:max-w-2xl lg:max-w-md">
          <img
            src="/analytics.png"
            ...
            loading="lazy"
          />
          <h2 className="text-4xl font-semibold mb-6">Advanced Analytics</h2>
        ...
        <div className="flex flex-col items-center justify-center text-center border border-blue-100 bg-white max-w-lg   py-5 md:max-w-2xl lg:max-w-md lg:-ml-44 xl:-ml-31">
          <img
            src="/blockchain.png"
            className="w-90 h-55 mb-11"
            alt="Example"
        ...
        <div className="flex flex-col items-center justify-center -ml-0 text-center border border-blue-100 bg-white max-w-lg py-5 md:max-w-2xl lg:max-w-md lg:-ml-44 xl:w-400 xl:ml-45 xl:!-ml-31">
          <img
            src="/concept.png"
            className="w-90 h-55 mb-11"
            alt="Example"
