...
const Quality = () => {
  return (
    <div className="w-full flex justify-center items-center min-h-screen ml-16 mt-24 md:ml-3 lg:max-w-full xl:-mt-30">
      <div className="flex flex-col justify-center items-center gap-12 xl:grid xl:grid-cols-2">
  
  {/* Top Content */}
  <div className="max-w-5xl text-black text-center sm:-ml-33 md:-ml-12 xl:ml-5 md:w-170 md:ml-0.5 xl:ml-48">
    <h1 className="text-md -ml-83  font-semibold md:-ml-130 lg:text-base lg:-ml-199 xl:text-base">
      WHAT WE DO BEST
    </h1>
    <h1 className="text-3xl sm:text-4xl font-semibold mt-2 -ml-67 sm:-ml-57 md:-ml-98 md:mt-1 lg:text-5xl lg:-ml-145 xl:text-4xl xl:-ml-57 xl:text-5xl xl:max-w-xl">
      Dare to innovate 
    ...
    <div className=" mt-4 lg:-ml-35">
      <p className="border-l-2 border-[#051753] pl-7 py-2  text-base leading-7 max-w-xs text-black my-4 text-left sm:max-w-lg lg:max-w-3xl xl:text-md xl:max-w-xl xl:py-1">
  ...
  <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 w-245 h-90 lg:-ml-71 xl:-mt-24">
    ...
    <div className="flex flex-col gap-6 w-full -ml-13 sm:-ml-16 md:ml-1  xl:ml-39">
    ...
    {/* Right column: Deploy */}
    <div className="flex flex-col justify-center items-center text-center shadow-sm h-70 w-130 p-4 ml-39 sm:ml-41  bg-[#f0f0f0] text-black  lg:h-72 mt-1 md:w-170 md:ml-36 lg:w-112 lg:mt-36 lg:ml-30 xl:w-68 xl:h-69 xl:ml-25">
